...
class Sidebar extends Component {
  ...
  render() {
        ...
        >
          ...
          <div id="sidenav-wrapper" className="sidenav-horizontal-wrapper">
            <ul
              ...
              onMouseLeave={() => this.props.navContentLeave()}
          ...
          {/* {this.state.upgrate ? (
            <div className="card text-center">
              <div className="card-block">
                <button onClick={this.upgrate} className="close" type="button">
                  ×
                </button>
    ...
    return (
      <nav
        className={`pcoded-navbar menu-light brand-blue active-blue caption-hide ${
          this.props.meunCol ? "navbar-collapsed" : ""
        } ${this.props.resMenu ? "mob-open" : ""}`}
        // className={classnames(`pcoded-navbar`, {
        //   "navbar-collapsed": this.props.meunCol,
        //   "menu-light":
        //     this.props.layoutType === "light" || this.props.menuBg === "light",
        //   "navbar-dark": this.props.layoutType === "dark",
        //   "icon-colored": this.props.iconColor,
        //   "menupos-fixed":
        //     this.props.menuFixed && this.props.layout === "vertical",
