const config = {
  // basename: "/etrack",
  basename: "",
  defaultPath: "/notFound",
  // collapseMenu: false,
  // layout: "vertical", // vertical, horizontal
  // layoutType: "default", //default, light, dark
  // prebuildLayout: "layout-3", // layout-2, layout-3,layout-4,layout-5,layout-6,layout-7,layout-8,layout-9,layout-10,layout-11,layout-12
  // iconColor: false,
  // menuFixed: true,
  // fixedHeader: true,
  // boxLayout: false,
  ...
  // menuBgGradient: "dark", //default,blue,red,purple,info,dark
