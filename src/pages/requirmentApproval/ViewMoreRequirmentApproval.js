...
class ViewMoreRequirmentApproval extends Component {
    constructor(props) {
        super(props);
    }
    ...
    render() {
        return (
            <Modal
                ...
                showModal={this.props.showRequirmentViewMoreModal}
                handleClose={this.props.closeRequirmentViewMoreModal}
                size="lg"
                isShowFooter={false}
            >
...
export default ViewMoreRequirmentApproval;
