...
const Configur = (state = options, action) => {
  switch (action.type) {
    ...
    case "MENU_DROPDOWN_ICON":
      return {
        ...state,
        menuDropdownIcon: action.layout,
      };
    case "MENU_LIST_STYLE":
      return {
        ...state,
