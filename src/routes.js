...
const RouteList = [
  ...
  {
    exact: true,
    path: "/etrack/lifeCycle/scrapApprove",
    name: "Scrap Approve",
    component: ScrapApprove,
  },
  {
    exact: true,
  ...
  {
    exact: true,
    path: "/etrack/structure/modifyComponent/:dispStructId/:dispReqId/:projStrId/:structName/:structCode/:project/:dcNumber",
  ...
  {
    exact: true,
    path: "/etrack/dispatch/vendorComp/:dispStrId/:subContId/:count/:name/:code",
    name: "Add Components",
